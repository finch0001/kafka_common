...
package com.intest.kafka.common.schema
 ...
 * versa.
 * @note copy from : https://github.com/databricks/spark-avro/blob/branch-3.2/src/main/scala/com/databricks/spark/avro/SchemaConverters.scala
 */
object DatabricksSchemaConverters {
